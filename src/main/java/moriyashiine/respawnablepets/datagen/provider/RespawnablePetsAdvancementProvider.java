...
public class RespawnablePetsAdvancementProvider extends FabricAdvancementProvider {
	public RespawnablePetsAdvancementProvider(FabricPackOutput output, CompletableFuture<HolderLookup.Provider> registriesFuture) {
